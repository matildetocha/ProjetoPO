...
public class Batch implements Serializable {
	...
	/** A Batch has a product associated whose quantity and price are defined in the respective Batch.
	 *  A Product can be present in multiple Batches, with different quantitys and price. */
	private Product _product;

	/** A Batch only has access one partner and a partner can have access to multiple Batches. */
	private Partner _partner;

	/**
	 * Batche's constructor that receives a product, a partner and the product's price and quantity.
	...
	/**
	 * Returns the conversion of the Batche's parametres to string to be displayed to the user.
	 * @return The Batche's description with it's Id, partner, price and quantity in a string
	 */
	@Override
